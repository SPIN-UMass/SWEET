...
sprintf(cmd, 
                                "sendemail -f mailmynet@hatswitch.crhc.illinois.edu -t jerryz2014@gmail.com -m 'oo' -u 'RE: www.google.com' -a %s",
tmp_file, 1);
  system(cmd);
#else
  {
    ...
    daemon_addr.sin_port = htons(3129);
...
//    hard code!
//
static const uint16_t kLocalPort = 3128;
